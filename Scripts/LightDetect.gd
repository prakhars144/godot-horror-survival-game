...
func _process(delta):
	...
	get_node("SubViewportContainer/SubViewport/Camera3D").global_position = Vector3(meshInstance.global_position.x, meshInstance.global_position.y + 1, meshInstance.global_position.z)
